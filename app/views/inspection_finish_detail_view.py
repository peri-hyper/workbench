...
from app.models import InspectionFinishDetailRecord, InspectionFinishRecord


class InspectionFinishDetailView(object):
    """
    成品检验 - 尺寸数据详情 API 视图
    """
    ...
    def query(self, request):
        """
        查询 InspectionFinishDetailRecord 列表（分页 & 简单搜索）
        ...
        try:
            ...
            query_set = InspectionFinishDetailRecord.objects.filter(
    ...
    def addRecord(self, request):
        ...
        try:
            ...
            for i, item in enumerate(data_list):
                ...
                new_record = InspectionFinishDetailRecord.objects.create(
    ...
    def deleteRecord(self, request):
        ...
        try:
            ...
            InspectionFinishDetailRecord.objects.filter(**idmap).delete()
    ...
    def editRecord(self, request):
        ...
        try:
            ...
            # 这里可以更新 required_value, actual_value, tolerance, judgment, etc.
            InspectionFinishDetailRecord.objects.filter(**idmap).update(**editForm)
